...
\sout{
	...
	ajustar um pouco para algo como:
- Propor uma estratégia para aumentar a eficiência na codificação

o que vai ter dentro da estratégia: recomendações (métricas para avaliar e ou monitorar o código)
}
